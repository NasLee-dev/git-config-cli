...
async function promptLoginInfo(): Promise<LoginCredentials> {
...
async function validateCredentials(credentials: LoginCredentials): Promise<boolean> {
  try {
...
async function main() {
  program
    ...
    .description('Manage GitHub configurations')
    .version('0.0.1');
  program.parse();
